<%@ WebHandler Language="C#" class="save_changesecanswer" %>
...
public class save_changesecanswer: IHttpHandler,System.Web.SessionState.IRequiresSessionState
{
	...
	{
		directoryLookup.logResultForSituation(context,"save_changesecanswer",sLogString);
	}
	...
	public void ProcessRequest(HttpContext context)
	{
        ...
        catch (Exception e)
        {
			...
			logResult(context, "save_changesecanswer Input Stream Parse Error :" + e.Message + e.StackTrace);
        }
		...
		try
		{
			...
			//directoryLookup.logActivity(context,"save_changesecanswer ashx", "Change sec answer" , context.Request.QueryString.ToString());
			...
			using (TransactionScope ts = new TransactionScope(TransactionScopeOption.RequiresNew))
			{
				...
				{	
					conUsrRole.Open();
					var sCommand="change_sec_ques_answer";
		...
		catch (Exception e)
		{
			...
			jsonString = JsonConvert.SerializeObject(statusObject, Formatting.None, settings);
			context.Response.Write(jsonString);
			logResult(context, "save_changesecanswer Error  :" + e.Message);
		}
	}
